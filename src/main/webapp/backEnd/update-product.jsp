							...
							<ul class="sidebar-links" id="simple-bar">
								...
								<li class="sidebar-list"><a
									...
									<ul class="sidebar-submenu">
										...
										<li><a
											href="<%=request.getContextPath()%>/backEnd/add-new-product.html">添加產品</a></li>

										<li><a
											href="<%=request.getContextPath()%>/backEnd/add-new-product2.html">添加團購</a></li>
									</ul></li>
											...
											<form METHOD="post" ACTION="pro.do" name="form1"
												...
												<div>
													...
													<input type="hidden" name="p_id"
														value="<%=proVO.getP_id()%>"> <input type="hidden"
														name="action" value="update">
													<button type="submit" class="btn  btn--yes btn-primary">送出修改</button>
													<div class="button-space" id="bSpace"></div>
												</div>
											</form>
										</div>
