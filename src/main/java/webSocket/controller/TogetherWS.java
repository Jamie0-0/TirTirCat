...
public class TogetherWS {
	//Set<Session>，其中Session同小吳老師上一個範例，建立連線
	private static final Set<Session> connectedSessions = Collections.synchronizedSet(new HashSet<>());
	//connectedSessions代表所有聊天室的人
	/*
	 ...
	 */
	@OnOpen
	//public void onOpen(@PathParam("userName") String userName, @PathParam("roomid") String roomid,Session userSession) throws IOException {
	public void onOpen(@PathParam("userName") String userName, Session userSession) throws IOException {
		//@PathParam同 htttp請求參數
